...
class TreeState:
    ...
    def move(self, nodes, anchor, where):
        ...
        #if self.tree not in __main__.list_of_trees:
            #__main__.list_of_trees.append(self.tree)
    ...
    def split(self, nodes):
        """
        Create new tree instans from the removed part of split tree.
        """
        t = tree.Tree(*nodes)

        kor.list_of_trees.append(t)
